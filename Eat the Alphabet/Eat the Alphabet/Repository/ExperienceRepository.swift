...
class ExperienceRepository {
    ...
    // add a User to the Experience, if succeed (unlikely this step would fail), append the User to the users/participants array in the Experience object, update it to the database
