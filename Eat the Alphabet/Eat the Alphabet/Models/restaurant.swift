...
class Restaurant {
    ...
    let price : Int
    let rating : Float
    let address : CLLocationCoordinate2D // TODO: change to 'coord' instead, address is a little misleading?
    // TODO: add address as a string
    let details : String?
    // TODO: add image's url if there is one
    let imageUrl : String?
